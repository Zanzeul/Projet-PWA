  ...
  return (
    <div
      className="
        ...
        grid-rows-[60px_1fr_auto]   /* Par défaut, 60px pour le header, reste pour le contenu, et une ligne pour la sidebar */
        md:grid-cols-[250px_1fr]   /* Sur desktop, sidebar à gauche */
        md:grid-rows-[60px_1fr]    /* Sur desktop, pas de ligne pour la sidebar en bas */
        [grid-template-areas:'header_header''content_content''sidebar_sidebar'] 
